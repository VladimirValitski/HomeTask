...
public class Bonus10_Array10 {
/* Get the sequence of elements of the main and 
 * secondary diagonal.*/
	public static void main(String[] args) throws Exception {
		BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
		try {
			System.out.println("¬ведите натуральное число n: ");
			...
			System.out.println();
			System.out.println("Ёлементы второстепенной диагонали");
			int k = 0;
