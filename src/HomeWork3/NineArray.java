...
public class NineArray {
	/*
	 * Rearrange all zeros in the end of the array, without changing the order
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			for (int n1 : arrayOne) {// print format array1
				System.out.print(n1 + " ");
			}
