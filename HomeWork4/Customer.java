...
public class Customer {
	...
	public Customer(int id,String surname,String name, String secondname, 
			String adress,int numberCreditCard,int numberBankCard){
		//create constructor
		this.id = id;
	...
	public void setNumberBankCard(int numberBankCard) {
		...
		@Override
        public String toString() // create @Override for change method toString() , for understanding output strings
        {
             return "Customer{ id: " + id + " " + surname + " " + name + " " + secondName + 
            		 ", adress: " + adress + ", numberCreditCard: " + numberCreditCard +
