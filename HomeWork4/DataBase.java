...
/* Creating customer databases*/
	public static void main(String[] args) {
		...
		System.out.println("Список покупателей, у которых номер кредитной карточки находится "
				+ "в интервале(2000-3000):");
...
private static void listCreditCard(Customer [] customer) {//create method for sort customers by CreditCard
		for (Customer cus: customer){
