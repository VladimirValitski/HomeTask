...
public class Calc {
	...
	public static void main(String[] args) throws Exception {
        ...
        {
        switch (symbol) {
        case ("+"): System.out.println(num1 + num2);break; //input character check
       	case ("-"): System.out.println(num1 - num2);break;
    	case ("*"): System.out.println(num1 * num2);break;
    	case ("/"): double result = num1*1.0 / num2 ; System.out.println(result);break;
    	default : System.out.println("Введен неверный символ");break;
        }
