...
public class Four_DelWords {
	...
	public static void main(String[] args) {
		...
		try {
		System.out.println("Введите число задающее длину слова: "); // enter number of length jf word 
		int lengthWord = Integer.parseInt(reader.readLine());
		String text = "Из текста! удалить все слова заданной длины, "
				+ "начинающиеся на согласную букву и еще.";//create string
